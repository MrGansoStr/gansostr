...
// import NeuronConnection from './components/NeuronConnection'; './components/NeuronConnection';
...
const Node: FC<NodeProps> = ({
  ...
  // Cargar el modelo OBJ de la neurona.
  ...
  useEffect(() => {
    if (obj) { 
      ...
      if ('isMesh' in child && child.isMesh) {
        ...
        metalness: 0.2,       // Ajusta según prefieras
        roughness: 0.5,       // Ajusta según prefieras
        // Asegúrate de no usar mapas si no los deseas.
        map: null,
        normalMap: null,
        roughnessMap: null,
        displacementMap: null,
      });
        // Si ya es MeshStandardMaterial, actualizamos el color;
        // de lo contrario, creamos uno nuevo.
        // if (child.material instanceof THREE.MeshStandardMaterial) {
        //   child.material.color.set(hovered ? hoverColor : color)
        // } else {
        //   child.material = new THREE.MeshStandardMaterial({ color: hovered ? hoverColor : color })
        // }
      }
    })
    }
